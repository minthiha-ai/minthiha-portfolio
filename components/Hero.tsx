            ...
            <div className="flex justify-center relative my-20 z-10">
                <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                    ...
                    <TextGenerateEffect
                        ...
                        words="Turning Challenges into Creative Web Solutions"
                    />
                    <p className="text-center md:tracking-wider mb-4 text-blue-100 text-sm md:text-lg lg:text-2xl">
                        Hi! I&apos;m Min Thiha, a Full-Stack Developer with a passion for crafting seamless web experiences that users love. From coding to problem-solving, I bring a blend of creativity and technology to every project.
                    </p>
                    <a href="#projects">
                        <MagicButton
