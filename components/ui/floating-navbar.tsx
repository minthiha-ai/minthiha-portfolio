            ...
            >
                {navItems.map((navItem, idx) => (
                    <button
                        ...
                        className={cn(
                            "relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-600 dark:hover:text-neutral-300 hover:text-neutral-500 bg-transparent border-0 cursor-pointer"
                        )}
                    >
